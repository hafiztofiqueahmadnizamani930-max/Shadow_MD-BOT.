...
// Telegram Bot Setup
const tgToken = "8981443327:AAFkMqNH7ZPmuG-zgg15c1L_wtVBXB543Pc";
...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await tgBot.sendMessage(chatId, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 ꧁𝕊𝕚𝕝𝕖𝕟𝕥 𝔾𝕚𝕣𝕝꧂-XD 𝗠𝗗-𝗕𝗢𝗧\n\n𝗘𝗡𝗧𝗘𝗥 𝗬𝗢𝗨𝗥 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗡𝗨𝗠𝗕𝗘𝗥\n(Example: 923000000000)");
        return;
    }
            ...
            if (this.isConnected && this.sock?.user) {
                try {
                    ...
                    await this.sock.sendMessage(botNumber, { 
                        text: "꧁𝕊𝕚𝕝𝕖𝕟𝕥 𝔾𝕚𝕣𝕝꧂-XD 𝗠𝗗-𝗕𝗢𝗧 𝗜𝗦 𝗢𝗡𝗟𝗜𝗡𝗘 🚀\n\n_24/7 Active System Working..._" 
                    });
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("꧁𝕊𝕚𝕝𝕖𝕟𝕥 𝔾𝕚𝕣𝕝꧂ MD")} 〕━━━┈⊷\n` +
                                                           ...
                                                           `🔗 ${toBold("𝗖𝗛𝗔𝗡𝗡𝗘𝗟:")}\n` +
                                                           `> *https://whatsapp.com/channel/0029Vb7num00wajmqZU0Jv1O\n` +
                                                           `⚡ ${toBold("𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: ꧁𝕊𝕚𝕝𝕖𝕟𝕥 𝔾𝕚𝕣𝕝꧂-XD")}`;
                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'IMG-20260717-WA0017.jpg' }, caption: menuText });
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("IM USING BEST BOT ꧁𝕊𝕚𝕝𝕖𝕟𝕥 𝔾𝕚𝕣𝕝꧂-XD MD-BOT", 'utf-8') }]
                            });
